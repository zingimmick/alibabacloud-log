...
class Client {
    ...
    /**
				 ...
				 * Unsuccessful opertaion will cause an Aliyun_Log_Exception.
				 * @param \Aliyun\Log\Models\LogStoreSqlRequest $request the executeLogStoreSql request parameters class
				 * @throws \Aliyun\Log\Exception
				 * @return \Aliyun\Log\Models\LogStoreSqlResponse
				 */
				public function executeLogStoreSql(\Aliyun\Log\Models\LogStoreSqlRequest $request) {
        $headers = array ();
        $params = array ();
        if ($request->getFrom () !== null)
            $params ['from'] = $request->getFrom ();
        ...
        $requestId = isset ( $header ['x-log-requestid'] ) ? $header ['x-log-requestid'] : '';
        $resp = $this->parseToJson ( $resp, $requestId );
        return new \Aliyun\Log\Models\LogStoreSqlResponse($resp, $header);
    }
    /**
				 * exeucte project sql.
				 * Unsuccessful opertaion will cause an Aliyun_Log_Exception.
				 *
				 * @param \Aliyun\Log\Models\ProjectSqlRequest $request the GetLogs request parameters class.
				 * @throws \Aliyun\Log\Exception
				 * @return array(json body, http header)
				 */
				public function executeProjectSqlJson(\Aliyun\Log\Models\ProjectSqlRequest $request) {
        $headers = array ();
        $params = array ();
        if ($request->getQuery () !== null)
            $params ['query'] = $request->getQuery ();
     ...
     /**
				 ...
				 * @return \Aliyun\Log\Models\Response\GetLogsResponse
				 */
				public function executeProjectSql(\Aliyun\Log\Models\ProjectSqlRequest $request) {
        $ret = $this->executeProjectSqlJson($request);
        $resp = $ret[0];
        $header = $ret[1];
        return new \Aliyun\Log\Models\ProjectSqlResponse ( $resp, $header );
    }
    /**
				 ...
				 * @throws \Aliyun\Log\Exception
				 * @return \Aliyun\Log\Models\CreateSqlInstanceResponse
				 */
				public function createSqlInstance($project, $cu)
    {
        ...
        $resp = $this->parseToJson ( $resp, $requestId );
        return new \Aliyun\Log\Models\CreateSqlInstanceResponse($resp,$header);   
    }
    ...
    /**
				 ...
				 * @param  $cu is max cores used concurrently in a project
				 * @throws \Aliyun\Log\Exception
				 * @return \Aliyun\Log\Models\UpdateSqlInstanceResponse
				 */
				public function updateSqlInstance($project, $cu)
    {
        ...
        $requestId = isset ( $header ['x-log-requestid'] ) ?
            $header ['x-log-requestid'] : '';
        $resp = $this->parseToJson ( $resp, $requestId );
        return new \Aliyun\Log\Models\UpdateSqlInstanceResponse($resp,$header);   
    }
    /**
				...
				public function listSqlInstance($project)
    {
        ...
        $requestId = isset ( $header ['x-log-requestid'] ) ?
            $header ['x-log-requestid'] : '';
        $resp = $this->parseToJson ( $resp, $requestId );
        return new \Aliyun\Log\Models\ListSqlInstanceResponse($resp,$header);   
    }
